...
class RPEAttention(nn.Module):
    ...
    def __init__(
        ...
        attn_drop=0., proj_drop=0., rpe_config=None
    ):
        super().__init__()
...
class RPEBlock(nn.Module):
    def __init__(
        ...
        act_layer=nn.GELU, norm_layer=nn.LayerNorm, rpe_config=None
    ):
        super().__init__()
        ...
        self.attn = RPEAttention(
            ...
            proj_drop=drop, rpe_config=rpe_config
        )
...
class VisionTransformer(nn.Module):
    ...
    def __init__(
        ...
        hybrid_backbone=None, norm_layer=nn.LayerNorm, rpe_config=None,
        *args, **kwargs
    ):
        super().__init__()
